...
//                   className="w-full bg-white/5 border border-white/20 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-[#76b900]"
//                 >
...
//                 : `No ${statusFilter} orders found. Try changing your filters.`}
//             </p>
//             <Link
//               to="/products"
//               className="inline-flex items-center justify-center rounded-lg bg-[#76b900] text-black font-medium px-6 py-3 hover:shadow-[0_0_10px_#76b900] hover:scale-105 transition-transform"
